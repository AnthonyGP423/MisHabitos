...
public class Constants {
    ...
    public static String ENDPOINT_INSIGNIA = "/insignia";
    public static String ENDPOINT_RECORDATORIO = "/recordatorio";
    public static String ENDPOINT_ROL = "/rol";
    public static String ENDPOINT_SEGUIMIENTO = "/seguimiento";
